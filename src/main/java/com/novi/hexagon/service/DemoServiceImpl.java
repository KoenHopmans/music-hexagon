...
@Service
public class DemoServiceImpl implements com.novi.hexagon.service.DemoService{
    ...
    public DemoServiceImpl(DemoRepository demoRepository, UserRepository userRepository,
